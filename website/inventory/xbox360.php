...
$game_list = $app->getThings(12);

//  define the total number of Xbox 360 games
$xbox360_total = 2103;
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Xbox 360</h1>
            <p class="lead">
                Games in inventory: <?php echo sizeof($game_list); ?>
                <br>
                Games not owned: <?php echo ($xbox360_total - sizeof($game_list)); ?>
            </p>
