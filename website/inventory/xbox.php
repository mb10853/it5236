...
$game_list = $app->getThings(11);

//  define the total number of Xbox games
$xbox_total = 1047;
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Xbox Original</h1>
            <p class="lead">
                Games in inventory: <?php echo sizeof($game_list); ?>
                <br>
                Games not owned: <?php echo ($xbox_total - sizeof($game_list)); ?>
            </p>
