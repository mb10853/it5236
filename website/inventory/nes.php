...
$game_list = $app->getThings(18);

//  define the total number of NES games
$nes_total = 714;
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Nintendo Entertainment System</h1>
            <p class="lead">
                Games in inventory: <?php echo sizeof($game_list); ?>
                <br>
                Games not owned: <?php echo ($nes_total - sizeof($game_list)); ?>
            </p>
