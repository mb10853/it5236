...
$game_list = $app->getThings(19);

//  define the total number of SNES games
$snes_total = 721;
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Super Nintendo Entertainment System</h1>
            <p class="lead">
                Games in inventory: <?php echo sizeof($game_list); ?>
                <br>
                Games not owned: <?php echo ($snes_total - sizeof($game_list)); ?>
            </p>
