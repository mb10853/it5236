...
$game_list = $app->getThings(49);

//  define the total number of Xbox One games
$xboxone_total = 1790;
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Xbox One</h1>
            <p class="lead">
                Games in inventory: <?php echo sizeof($game_list); ?>
                <br>
                Games not owned: <?php echo ($xboxone_total - sizeof($game_list)); ?>
            </p>
